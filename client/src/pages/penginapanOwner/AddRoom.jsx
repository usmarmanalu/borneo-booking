...
const AddRoom = () => {
  ...
  return (
    <form onSubmit={onSubmitHandler}>
        <Title align='left' font='outfit' title='Add Room' subTitle='Lorem, ipsum dolor sit amet consectetur adipisicing elit. Amet,
            ...
            <div className='grid grid-ccols-2 sm:flex gap-4 my-2 flex-wrap'>
            ...
            <div className='w-full flex max-sm:flex-col sm:gap-4 mt-4'>
                <div className='flex-1 max-w-48'>
                    <p className='text-gray-800 mt-4'>Romm Type</p>
                    <select value={inputs.roomType} onChange={e=> setInputs({...inputs, roomType:e.target.value})}
                    className='border opaccity-70 border-gray-300 mt-1 rounded p-2 w-full'>
            ...
            <div className='flex flex-col flex-wrap mt-1 text-gray-400 max-w-sms'>
